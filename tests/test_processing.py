...
def test_filter_by_state(dictionary_array, state, expected):
    assert filter_by_state(dictionary_array, state) == expected
...
def test_sort_by_date(dictionary_array, flag, expected):
    assert sort_by_date(dictionary_array, flag) == expected
