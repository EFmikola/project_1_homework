...
def test_card_number_generator():
    generator = gen.card_number_generator(1, 5)
    assert next(generator) == "0000 0000 0000 0001"
    assert next(generator) == "0000 0000 0000 0002"
    assert next(generator) == "0000 0000 0000 0003"
    generator = gen.card_number_generator(9999999999999995, 9999999999999999)
...
@pytest.mark.parametrize("code, filtered_by_cur", [
    ("RUB", [
        {
            "id": 873106923,
            "state": "EXECUTED",
...
def test_filter_by_currency(code, filtered_by_cur):
    assert list(gen.filter_by_currency(transactions, code)) == filtered_by_cur


def test_transaction_descriptions():
    generator_descriptions = gen.transaction_descriptions(transactions)
